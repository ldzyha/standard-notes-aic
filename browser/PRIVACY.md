...
- `clipboardRead`: read the latest clipboard text only when you press an explicit field Paste or Add content → Paste from clipboard action. No monitoring, clipboard-history collection or background reads.
