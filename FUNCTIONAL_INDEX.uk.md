...
Випуск 46.0.2 на спільному ядрі 7.3.2 узгоджено з AIC Notes 54.0.2 та
браузером 0.9.2.
...
Хост і далі володіє збереженням чернетки та підтвердженням запису. Формати
Markdown і сховища не змінено.
